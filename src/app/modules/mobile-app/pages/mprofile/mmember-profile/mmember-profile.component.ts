...
@Component({
  selector: 'app-mmember-profile',
  templateUrl: './mmember-profile.component.html',
  styleUrls: ['./mmember-profile.component.css']
})
export class MmemberProfileComponent implements OnInit {
